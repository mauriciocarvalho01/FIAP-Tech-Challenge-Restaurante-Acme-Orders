...
export interface Order {
  ...
  saveIngredientProduct: (
    input: Order.InsertIngredientProductInput
  ) => Promise<Order.InsertIngredientProductOutput>;
  findProduct: (
    input: Order.FindProductInput
  ) => Promise<Order.FindProductOutput>;
  findIngredient: (
    input: Order.FindIngredientInput
  ) => Promise<Order.FindIngredientOutput>;
  deleteOrder: (
    input: Order.FindOrderInput
  ...
  deleteIngredientProduct: (
    orderProductData: Partial<Order.InsertIngredientProductInput>
...
export namespace Order {
  ...
  export type InsertOrderProductOutput =
    | undefined
    | {
        id: number;
        count: number;
  ...
  export type DeleteOrderProductOutput =
    | undefined
    | {
        orderId: string;
        productId: string;
  ...
  export type InsertIngredientProductOutput =
    | undefined
    | {
        id: number;
        count: number;
  ...
  export type DeleteIngredientProductOutput =
    | undefined
    | {
        ingredientId: string;
