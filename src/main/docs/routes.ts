  ...
  CreateOrderProductInput: {
    ...
    type: {
      ...
      nestedProperties: {
        ingredientProducts: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'CreateIngredientProductInput' },
        },
        count: { dataType: 'double', required: true },
  ...
  'OrderHttp.CreateOrderInput': {
    ...
    type: {
      ...
      nestedProperties: {
        orderProducts: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'CreateOrderProductInput' },
          required: true,
        },
    ...
    type: {
      ...
      subSchemas: [
        { dataType: 'undefined' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            order: { ref: 'GenericType', required: true },
            expirationDate: { dataType: 'datetime', required: true },
            pixCode: { dataType: 'string', required: true },
            pixUrl: { dataType: 'string', required: true },
            status: { dataType: 'string', required: true },
  ...
  OrderProductOutput: {
    ...
    type: {
      ...
      nestedProperties: {
        ingredientProducts: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'OrderProductIngredientOutput' },
          required: true,
        },
        price: { dataType: 'double', required: true },
        category: { ref: 'OrderProductCategoryOutput', required: true },
        count: { dataType: 'double', required: true },
        description: { dataType: 'string', required: true },
        name: { dataType: 'string', required: true },
        productId: { dataType: 'string', required: true },
      ...
      subSchemas: [
        { dataType: 'undefined' },
        {
          ...
          nestedProperties: {
            ...
            orderProducts: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'OrderProductOutput' },
              required: true,
            },
            client: { ref: 'Register.FindClientOutput' },
            createdAt: { dataType: 'string', required: true },
            payments: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'FindPaymentOutput' },
              required: true,
            },
            status: { dataType: 'string', required: true },
            orderId: { dataType: 'string', required: true },
  ...
  'OrderHttp.UpdateOrderInput': {
    ...
    type: {
      ...
      nestedProperties: {
        orderProducts: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'UpdateOrderProductInput' },
          required: true,
        },
        orderId: { dataType: 'string', required: true },
      },
    ...
    type: {
      ...
      subSchemas: [
        { dataType: 'undefined' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            category: { ref: 'ProductOutput', required: true },
            price: { dataType: 'double', required: true },
            description: { dataType: 'string', required: true },
            name: { dataType: 'string', required: true },
            productId: { dataType: 'string', required: true },
      ...
      subSchemas: [
        { dataType: 'undefined' },
        {
          ...
          nestedProperties: {
            ingredients: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'IngredientsOutput' },
              required: true,
            },
            products: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'ProductOutput' },
              required: true,
            },
            name: { dataType: 'string', required: true },
            id: { dataType: 'double', required: true },
  ...
  'Order.FindCategoriesOutput': {
    ...
    type: {
      ...
      subSchemas: [
        {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'FindCategoryOutput' },
        },
        { dataType: 'undefined' },
      ],
      validators: {},
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      HealthCheckDoc.prototype.getHealthCheck
    ),

    function HealthCheckDoc_getHealthCheck(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getHealthCheck.apply(
          controller,
  ...
  app.post(
    ...
    function CreateOrderDoc_CreateOrder(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        _body: {
          ...
          name: '_body',
          required: true,
          ref: 'OrderHttp.CreateOrderInput',
        },
      };
  ...
  app.get(
    ...
    function FindOrderDoc_FindOrder(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.FindOrder.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.put(
    ...
    function UpdateOrderDoc_UpdateOrder(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        _body: {
          ...
          name: '_body',
          required: true,
          ref: 'OrderHttp.UpdateOrderInput',
        },
      };
      ...
      try {
        ...
        const promise = controller.UpdateOrder.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.delete(
    ...
    function DeleteOrderDoc_DeleteOrder(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.DeleteOrder.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(
      UpdateOrderStatusDoc.prototype.UpdateOrderStatus
    ),

    function UpdateOrderStatusDoc_UpdateOrderStatus(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        _body: {
          ...
          name: '_body',
          required: true,
          ref: 'OrderHttp.UpdateOrderStatusInput',
        },
      };
      ...
      try {
        ...
        const promise = controller.UpdateOrderStatus.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FindAllOrdersDoc.prototype.FindAllOrders
    ),

    function FindAllOrdersDoc_FindAllOrders(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.FindAllOrders.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      UpdatePaymentStatusDoc.prototype.UpdatePaymentStatus
    ),

    function UpdatePaymentStatusDoc_UpdatePaymentStatus(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        _body: {
          ...
          name: '_body',
          required: true,
          ref: 'OrderHttp.UpdatePaymentStatusInput',
        },
      };
      ...
      try {
        ...
        const promise = controller.UpdatePaymentStatus.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function CreateClientDoc_CreateClient(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        _body: {
          ...
          name: '_body',
          required: true,
          ref: 'ClientHttp.CreateClientInput',
        },
      };
      ...
      try {
        ...
        const promise = controller.CreateClient.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function FindClientDoc_FindClient(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.FindClient.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function FindProductDoc_FindProduct(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.FindProduct.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FindProductsCategoriesDoc.prototype.FindProductsCategories
    ),

    function FindProductsCategoriesDoc_FindProductsCategories(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.FindProductsCategories.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      CreateCheckoutDoc.prototype.CreateOrder
    ),

    function CreateCheckoutDoc_CreateOrder(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        _body: {
          ...
          name: '_body',
          required: true,
          ref: 'OrderHttp.CreateCheckoutInput',
        },
      };
